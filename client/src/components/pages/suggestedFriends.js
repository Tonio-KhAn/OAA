        ...
        <Aux>
            ...
            <Col>
                        <Card className='Suggested-Users'>
                            <Card.Header>
                                <Card.Title as='h5'>Suggested Friends</Card.Title>
                            </Card.Header>
                            <Card.Body className='px-0 py-2'>
                                <Table responsive hover>
                                    ...
                                    <tr className="unread">
                                        ...
                                        <td><a href="http://localhost:3000/" className="label theme-bg2 text-white f-12">Reject</a><a href="http://localhost:3000/" className="label theme-bg text-white f-12">Add</a></td>
                                    </tr>
                                    <tr className="unread">
